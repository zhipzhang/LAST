...
/** @file initial.h
    ...
    @date    1991 to 2010
    @date    @verbatim $Date: 2018/11/26 12:29:34 $ @endverbatim
    @version @verbatim $Revision: 1.20 $ @endverbatim
...
#define CPU_PowerPC 1
      ...
      (defined(__alpha) || defined(__alpha__))) /* DEC Unix */
#define OS_UNIX 1
#define OS_DECUNIX 1
#define CPU_ALPHA 1
#define SIXTY_FOUR_BITS 1
