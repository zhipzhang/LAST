/* ============================================================================
   ...
   Copyright (C) 2000, 2003, 2008, 2009, 2010, 2011, ..., 2021, 2022  Konrad
Bernloehr
 ...
 *
 *  @date    @verbatim CVS $Date: 2022/04/06 20:32:38 $ @endverbatim
 *  @version @verbatim CVS $Revision: 1.115 $ @endverbatim
 */
...
#define HI_GAIN                                                                \
  0 /**< Index to high-gain channels in adc_sum, adc_sample, pedestal, ... */
#define LO_GAIN                                                                \
  1 /**< Index to low-gain channels in adc_sum, adc_sample, pedestal, ... */
...
#define LACT_MAX_DRAWERS LACT_MAX_PIX
...
/*------------------Set H_MAX_* to LACT_MAX_*------------------------*/
#ifndef H_MAX_TEL
#define H_MAX_TEL LACT_MAX_TEL /**< Maximum number of telescopes handled */
#endif
#ifndef H_MAX_PIX
#define H_MAX_PIX LACT_MAX_PIX /**< Maximum number of pixels handled */
#endif
#ifndef H_MAX_SECTORS
#define H_MAX_SECTORS LACT_MAX_SECTORS
#endif
#ifndef H_MAX_SLICES
#define H_MAX_SLICES LACT_MAX_SLICES
#endif
#ifndef H_MAX_PIXSECTORS
#define H_MAX_PIXSECTORS LACT_MAX_PIXSECTORS
#endif
#ifndef H_MAX_DRAWERS
#define H_MAX_DRAWERS LACT_MAX_DRAWERS
#endif
#ifdef NO_LOW_GAIN
...
#define H_MAX_FSHAPE                                                           \
  10000 /**< Max. number of (sub-) samples of reference pulse shapes. */
...
#define H_CHECK_MAX()                                                          \
  check_hessio_max(11, H_MAX_TEL, H_MAX_PIX, H_MAX_SECTORS, H_MAX_DRAWERS,     \
                   H_MAX_PIXSECTORS, H_MAX_SLICES, H_MAX_HOTPIX,               \
                   H_MAX_PROFILE, H_MAX_D_TEMP, H_MAX_C_TEMP, H_MAX_GAINS);

void check_hessio_max(int ncheck, int max_tel, int max_pix, int max_sectors,
                      int max_drawers, int max_pixsectors, int max_slices,
                      int max_hotpix, int max_profile, int max_d_temp,
                      int max_c_temp, int max_gains);
...
#define IMAGE_FLAG                                                             \
  (IMG_BASE_FLAG | IMG_ERR_FLAG | IMG_34M_FLAG | IMG_HOT_FLAG | IMG_PIXTM_FLAG)
...
/** Since it is actually more generic than for just one instrument,
    we may eventually rename all the data blocks (keeping numbers). */
#define IO_TYPE_SIMTEL_BASE IO_TYPE_HESS_BASE
#define IO_TYPE_SIMTEL_RUNHEADER IO_TYPE_HESS_RUNHEADER
#define IO_TYPE_SIMTEL_MCRUNHEADER IO_TYPE_HESS_MCRUNHEADER
#define IO_TYPE_SIMTEL_CAMSETTINGS IO_TYPE_HESS_CAMSETTINGS
#define IO_TYPE_SIMTEL_CAMORGAN IO_TYPE_HESS_CAMORGAN
#define IO_TYPE_SIMTEL_PIXELSET IO_TYPE_HESS_PIXELSET
#define IO_TYPE_SIMTEL_PIXELDISABLE IO_TYPE_HESS_PIXELDISABLE
#define IO_TYPE_SIMTEL_CAMSOFTSET IO_TYPE_HESS_CAMSOFTSET
#define IO_TYPE_SIMTEL_POINTINGCOR IO_TYPE_HESS_POINTINGCOR
#define IO_TYPE_SIMTEL_TRACKSET IO_TYPE_HESS_TRACKSET
#define IO_TYPE_SIMTEL_CENTEVENT IO_TYPE_HESS_CENTEVENT
#define IO_TYPE_SIMTEL_TRACKEVENT IO_TYPE_HESS_TRACKEVENT
#define IO_TYPE_SIMTEL_TELEVENT IO_TYPE_HESS_TELEVENT
#define IO_TYPE_SIMTEL_EVENT IO_TYPE_HESS_EVENT
#define IO_TYPE_SIMTEL_TELEVTHEAD IO_TYPE_HESS_TELEVTHEAD
#define IO_TYPE_SIMTEL_TELADCSUM IO_TYPE_HESS_TELADCSUM
#define IO_TYPE_SIMTEL_TELADCSAMP IO_TYPE_HESS_TELADCSAMP
#define IO_TYPE_SIMTEL_TELIMAGE IO_TYPE_HESS_TELIMAGE
#define IO_TYPE_SIMTEL_SHOWER IO_TYPE_HESS_SHOWER
#define IO_TYPE_SIMTEL_PIXELTIMING IO_TYPE_HESS_PIXELTIMING
#define IO_TYPE_SIMTEL_PIXELCALIB IO_TYPE_HESS_PIXELCALIB
#define IO_TYPE_SIMTEL_MC_SHOWER IO_TYPE_HESS_MC_SHOWER
#define IO_TYPE_SIMTEL_MC_EVENT IO_TYPE_HESS_MC_EVENT
#define IO_TYPE_SIMTEL_TEL_MONI IO_TYPE_HESS_TEL_MONI
#define IO_TYPE_SIMTEL_LASCAL IO_TYPE_HESS_LASCAL
#define IO_TYPE_SIMTEL_RUNSTAT IO_TYPE_HESS_RUNSTAT
#define IO_TYPE_SIMTEL_MC_RUNSTAT IO_TYPE_HESS_MC_RUNSTAT
#define IO_TYPE_SIMTEL_MC_PE_SUM IO_TYPE_HESS_MC_PE_SUM
#define IO_TYPE_SIMTEL_PIXELLIST IO_TYPE_HESS_PIXELLIST
#define IO_TYPE_SIMTEL_CALIBEVENT IO_TYPE_HESS_CALIBEVENT
#define IO_TYPE_SIMTEL_AUX_DIGITAL_TRACE IO_TYPE_HESS_AUX_DIGITAL_TRACE
#define IO_TYPE_SIMTEL_AUX_ANALOG_TRACE IO_TYPE_HESS_AUX_ANALOG_TRACE
#define IO_TYPE_SIMTEL_FS_PHOT IO_TYPE_HESS_FS_PHOT
#define IO_TYPE_SIMTEL_PIXELTRG_TM IO_TYPE_HESS_PIXELTRG_TM
#define IO_TYPE_SIMTEL_MC_PIXMON IO_TYPE_HESS_MC_PIXMON
...
struct hess_mc_run_header_struct {
  ...
  time_t shower_prog_start;   ///< Time when shower simulation of run started
                              ///(CORSIKA: only date)
  ...
  double viewcone[2]; ///< Min.+max. opening angle for diffuse mode [degrees]
                      ///(was always in degrees despite earlier '[rad]'
  /// comment).
...
struct hess_camera_settings_struct {
  ...
  double zpix[H_MAX_PIX]; ///< Pixel z position w.r.t. focal plane in camera
  /// center [m].  {new}
  double nxpix[H_MAX_PIX]; ///< Pixel pointing direction (nx,ny,1) x component.
                           ///{new}
  double nypix[H_MAX_PIX]; ///< Pixel pointing direction (nx,ny,1) y component.
                           ///{new}
  double area[H_MAX_PIX];  ///< Pixel active area ([m^2]).
  double size[H_MAX_PIX];  ///< Pixel diameter (flat-to-flat, [m]).
  int pixel_shape[H_MAX_PIX]; ///< Pixel shape type (0: circ., 1,3: hex, 2:
  /// square, -1: unknown). {new}
  double cam_rot; ///< Rotation angle of camera (counter-clock-wise from back
  /// side for prime focus camera).
  // Main telescope optics parameters included here:
  double flen;     ///< Focal length of optics (geometric or nominal) [m].
  double eff_flen; ///< Suggested effective focal length for image scale (can be
  /// zero). [m]
  double eff_flen_x; ///< Value may be different in x projection if mirror not
  /// rotationally symmetric. [m]
  double eff_flen_y; ///< Value may be different in y projection if mirror not
  /// rotationally symmetric. [m]
  double eff_flen_dx; ///< Displacement of image c.o.g. in x by asymmetric
  /// mirror [m]
  double eff_flen_dy; ///< Displacement of image c.o.g. in y by asymmetric
  /// mirror [m]
  ...
  int pixels_parallel; ///< 0 if (some) pixels are inclined, 1 if all pixels are
  /// parallel {new}
  int common_pixel_shape; ///< instead of individual pixel shape if al pixels
                          /// are the same. {new}
};
...
struct hess_camera_organisation_struct {
  ...
  int sectors[H_MAX_PIX][H_MAX_PIXSECTORS]; ///< Pixels in sectors (trigger
  /// groups).
  int sector_type[H_MAX_SECTORS]; ///< 0: majority, 1: analog sum, 2: digital
                                  /// sum
  ...
  double sector_threshold[H_MAX_SECTORS]; ///< Multiplicity or sum threshold
  /// applied to sector. [mV ?]
  double sector_pixthresh[H_MAX_SECTORS]; ///< Pixel threshold for majority or
                                          /// clipping limit for sum triggers.
                                          ///[mV ?]
};
...
struct hess_pixel_setting_struct {
  ...
  int sum_bins; ///< Standard integration or readout or peak search over so many
  /// time slices.
  int sum_offset; ///< How many time slices this is supposed to start before
  /// telescope trigger.
  int nrefshape; ///< Number of following reference pulse shapes (num_gains or
  /// 0)
...
struct hess_tel_event_adc_struct {
  ...
  /// Bit 0: sum, 1: samples.
  uint8_t adc_known[H_MAX_GAINS][H_MAX_PIX]; ///< Was individual channel
  /// recorded? Bit 0: sum, 1:
  /// samples, 2: ADC was in
  /// saturation.
  uint32_t adc_sum[H_MAX_GAINS][H_MAX_PIX]; ///< Sum of ADC values.
  uint16_t adc_sample[H_MAX_GAINS][H_MAX_PIX][H_MAX_SLICES]; ///< Pulses
                                                             /// sampled.
};
...
struct hess_aux_digital_trace {
  int known; ///< Must be set to 1 if and only if corresponding data is
  /// available.
  int tel_id;     ///< Must match the expected telescope ID when reading.
  int trace_type; ///< Indicate what type of trace we have (1: DigitalSum
  /// trigger trace)
  float time_scale; ///< Time per auxilliary sample over time per normal FADC
  /// sample (typ.: 1.0)
  size_t num_traces;    ///< The number of traces coming from the camera.
  size_t len_traces;    ///< The length of each trace in FADC samples.
  uint16_t *trace_data; ///< Allocated on first use with num_traces*len_traces
                        /// elements.
};
...
struct hess_aux_analog_trace {
  ...
  /// available.
  int tel_id;     ///< Must match the expected telescope ID when reading.
  int trace_type; ///< Indicate what type of trace we have (1: pixel input, 2:
  /// analog sum, 3: disc/comp. output, 4: majority input)
  float time_scale; ///< Time per auxilliary sample over time per normal FADC
  /// sample (typ.: 0.25)
  size_t num_traces; ///< The number of traces coming from the camera.
  size_t len_traces; ///< The length of each trace in FADC samples.
  float *trace_data; ///< Allocated on first use with num_traces*len_traces
                     /// elements.
};
...
#define PIX_TIME_PEAKPOS_TYPE                                                  \
  1 /**< Position of peak in time (slices since readout). */
#define PIX_TIME_STARTPOS_REL_TYPE                                             \
  2 /**< Position of first rise above fraction of peak ampl. */
#define PIX_TIME_STARTPOS_ABS_TYPE                                             \
  3 /**< Position of first rise above absolute threshold. */
#define PIX_TIME_WIDTH_REL_TYPE                                                \
  4 /**< Width of pulse over fraction of peak ampl. */
#define PIX_TIME_WIDTH_ABS_TYPE                                                \
  5 /**< Width of pulse over absolute threshold (time over threshold). */
...
struct hess_pixeltrg_time_struct {
  int known;        ///< is pixel timing data known?
  int tel_id;       ///< Telescope ID
  double time_step; ///< Time interval [ns] after telescope trigger in which
  /// times are reported.
  int num_times; ///< Number of fired discriminators for which time gets
  /// reported.
  int pixel_list[H_MAX_PIX]; ///< List of pixels IDs for which times get
  /// reported.
  int pixel_time[H_MAX_PIX]; ///< Time when pixel disciminator/comparator fired,
                             /// in units of given time intercal since telescope
                             /// trigger.
};
...
struct hess_pixel_calibrated_struct {
  ...
  int tel_id;     ///< Telescope ID
  int num_pixels; ///< Pixels in camera: list should be in this range.
  int int_method; ///< -2 (timing local peak), -1 (timing global peak), >=0
                  ///(integration scheme, if known)
  int list_known; ///< Was list of significant pixels filled in? 1: use list, 2:
  /// all pixels significant
  int list_size; ///< Size of the list of available pixels (with list mode).
  int pixel_list[H_MAX_PIX]; ///< List of available pixels (with list mode).
  uint8_t significant[H_MAX_PIX]; ///< Was amplitude large enough to record it?
  float pixel_pe[H_MAX_PIX];      ///< Calibrated & flat-fielded pixel intensity
                                  ///[p.e.]
};
...
struct hess_tel_image_struct {
  ...
  double clip_amp;  ///< Pixel amplitude clipping level [mean p.e.] or zero for
  /// no clipping.
  int num_sat; ///< Number of pixels in saturation (ADC saturation or dedicated
  /// clipping).
  /** Position */
  ...
  /** Orientation */
  double phi; ///< Angle of major axis w.r.t. x axis [rad], corrected for any
  /// camera rotation.
  double phi_err; ///< Error on phi (0: error not known, <0: phi not known)
                  ///[rad]
  /** Shape */
  ...
  double concentration; ///< Fraction of total amplitude in num_conc hottest
  /// pixels
  /** Timing */
  double tm_slope;    ///< Slope in peak times along major axis as given by phi.
                      ///[ns/rad]
  double tm_residual; ///< R.m.s. average residual time after slope correction.
                      ///[ns]
  double tm_width1;   ///< Average pulse width (50% of peak or time over
  /// threshold) [ns]
...
struct hess_tel_event_data_struct {
  ...
  double time_readout; ///< Time when readout starts (+array-wide arbitrary
  /// offset) [ns]
  double time_trg_rel; ///< Time of telescope trigger relative to start of
  /// readout. [ns]
  ...
  double time_trgsect[H_MAX_SECTORS]; ///< Times when trigger groups (as in
  /// list) fired.
  //   char type_trgsect[H_MAX_SECTORS]; ///< 0: majority, 1: analog sum, 2:
  // digital sum.
  ...
  PixelCalibrated *pixcal; ///< Pointer to calibrated pixel intensities, if
  /// available.
  ...
  AuxTraceD aux_trace_d[MAX_AUX_TRACE_D]; ///< Optional auxilliary digital
  /// traces.
  AuxTraceA aux_trace_a[MAX_AUX_TRACE_A]; ///< Optional auxilliary analog
                                          /// traces.
};
...
struct hess_central_event_data_struct {
  ...
  float teltrg_time_by_type[H_MAX_TEL][H_MAX_TRG_TYPES]; ///< Time of trigger
  /// separate for each
  /// type.
  int num_teldata;             ///< Number of telescopes expected to have data.
  int teldata_list[H_MAX_TEL]; ///< List of IDs of telescopes with data.
  double az_comp; ///< Azimuth angle for which plane wavefront compensation was
  /// evaluated. [radian]
  double alt_comp; ///< Altitude angle for which plane wavefront compensation
  /// was evaluated. [radian]
  double ls_comp; ///< Assumed light speed (in air) for plane wavefront
                  /// compensation. [cm/ns]
};
...
struct hess_shower_parameter {
  ...
  int img_pattern; ///< Bit pattern of which telescopes were used (for small no.
  /// of telescopes only).
  int img_list[H_MAX_TEL]; ///< With more than 16 or 32 telescopes, we can only
  /// use the list.
  ...
  double err_dir1;  ///< Error estimate in nominal plane X direction (|| Alt)
                    ///[rad]
  double err_dir2;  ///< Error estimate in nominal plane Y direction (|| Az)
                    ///[rad]
  double err_dir3;  ///< ?
  ...
  double err_core3; ///< ?
  double mscl;      ///< Mean scaled image length [gammas ~1 (HEGRA-style) or ~0
                    ///(HESS-style)].
  double err_mscl;
  double mscw; ///< Mean scaled image width [gammas ~1 (HEGRA-style) or ~0
               ///(HESS-style)].
  double err_mscw;
...
struct hess_mc_pe_sum_struct {
  ...
  int pix_pe[H_MAX_TEL][H_MAX_PIX]; ///< Photo-electrons per pixel (without
  /// NSB).
  double photons[H_MAX_TEL]; ///< The sum of the photon content of all bunches.
  double photons_atm[H_MAX_TEL]; ///< Photons surviving atmospheric
  /// transmission.
  double photons_atm_3_6[H_MAX_TEL]; ///< Photons surv. atm. tr. in the 300 to
  /// 600 nm range.
  double photons_atm_400[H_MAX_TEL]; ///< Photons surv. atm. tr. in the 350 to
  /// 450 nm range.
  double photons_atm_qe[H_MAX_TEL]; ///< Photons surviving atmospheric
                                    /// transmission,
...
struct hess_mc_fs_phot {
  ...
  struct fs_photon *phot; ///< Only allocated on demand; not needed for normal
  /// simulations.
  int max_phot; ///< How many we can store in 'phot' above, without
                /// re-allocating.
};
...
struct hess_mc_pe_list {
  ...
  int photon_count[H_MAX_PIX]; ///< The numbers of photons arriving at each
/// pixel.
///< For efficiency reasons not filled in normal simulations.
#endif
  int pe_count[H_MAX_PIX]; ///< The numbers of p.e. at each pixel.
  int itstart[H_MAX_PIX];  ///< The start index for each pixel in the sequential
  /// atimes vector.
  ...
  int max_npe; ///< How many p.e. we can store in the atimes (+amplitudes)
               /// vector(s).
};

/** Monte Carlo pixel 'monitoring' with parameters as actually used in
 * simulation */

struct hess_mc_pixel_monitor_struct {
  int tel_id; ///< Telescope ID number.
  int flags; ///< Bit 0: NSB p.e. rate, bit 1: rel. QE, bit 2: gain rel., bit 3:
  /// HV rel., ...
  int num_pixels; ///< Number of pixels in camera.
  int num_gains;  ///< Number of different electronics gains for read-out (1 or
  /// 2).
  ...
  double current[H_MAX_PIX];     ///< Assumed current at pixel
  double fadc_amp[H_MAX_GAINS][H_MAX_PIX]; ///< Assumed FADC amplitude per mean
  /// p.e.
  BYTE disabled[H_MAX_PIX]; ///< Pixel totally off and/or disabled in trigger.
};
typedef struct hess_mc_pixel_monitor_struct MCPixelMonitor;
...
struct hess_mc_event_struct {
  ...
  struct hess_mc_pe_sum_struct mc_pesum; ///< Numbers of / sums of
  /// photo-electrons.
  struct hess_mc_photons mc_photons[H_MAX_TEL]; ///< Raw simulated photons
                                                ///(fiducial sphere).
  struct hess_mc_pe_list mc_pe_list[H_MAX_TEL]; ///< List of detected
  /// photo-electrons.
  struct hess_mc_fs_phot mc_phot_list[H_MAX_TEL]; ///< List of photons imaged
                                                  /// onto focal surface.
};
...
struct hess_tel_monitor_struct {
  ...
  int tel_id;      ///< Telescope ID number.
  int num_sectors; ///< Number of sector available for trigger (default
  /// trigger).
  int num_pixels;  ///< Number of pixels in camera.
  ...
  /** These have to be obtained from the camera trigger electronics (first
   * trigger type only)*/
  ...
  double pedsamp[H_MAX_GAINS][H_MAX_PIX];  ///< Corresponding pedestal per
  /// sample.
  double noise[H_MAX_GAINS][H_MAX_PIX]; ///< Average noise on ADC sums.

  /** Pedestal compensation (optional) */
  int ped_comp_rel[H_MAX_GAINS][H_MAX_PIX]; ///< Values added to ADC counts for
...
struct hess_laser_calib_data_struct {
  ...
  double ff_corr[H_MAX_GAINS]
                [H_MAX_PIX]; /**< Flat-field correction as part of 'calib' */
};
...
int read_hess_calib_event(IO_BUFFER *iobuf, FullEvent *ev, int what,
                          int *ptype);
